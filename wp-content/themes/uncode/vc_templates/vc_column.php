...
global $metabox_data, $inner_column_style, $previous_blend;
...
if ($border_color !== '') {
	...
	if ($border_style !== '') {
		$uncell_style = ' style="border-style: ' . esc_attr( $border_style ) . ';"';
	}
}
